...
class CommonPlatform ():
    ...
    '''
    PackagesSupported = ("x00tdPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('x00td', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "x00td", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "x00tdPkg/x00td.dsc", "Platform Hardcoded")
